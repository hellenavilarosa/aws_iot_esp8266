...
//#define WEB_SERVER "192.168.0.9"
#define WEB_PORT "10000"
#define WEB_PATH "/get"
...
void http_get_task(void *pvParameters)
{
	...
	// mudar aqui as coisas pra enviar

        //const uint16_t *req = &valor;
	...
	bzero(buffer, 4);
      ...
      snprintf(buffer, 4, "%d", valor);
      printf("data to be sent: %d\r\n",valor);
      printf("data to be sent(buffer): %d\r\n",buffer);
...
void user_init(void)
{
    ...
    xTaskCreate(&http_get_task, "get_task", 384, NULL, 1, NULL);
